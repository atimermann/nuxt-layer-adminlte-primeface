import { getCurrentInstance, version, h, inject, ref, watchEffect, watch, defineComponent, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, nextTick, resolveComponent, resolveDirective, openBlock, createElementBlock, Fragment as Fragment$1, renderList, normalizeStyle, normalizeClass, createElementVNode, createBlock, withCtx, withDirectives, createCommentVNode, toDisplayString, resolveDynamicComponent, createVNode, Transition, vShow, renderSlot, Teleport, mergeProps, createTextVNode, createSlots, toHandlers, withKeys, withModifiers, vModelText } from 'vue';
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/index-73e96795.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  admin: () => import('./_nuxt/admin-3641a900.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-f5fbecbb.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-94fcbf67.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _wrapIf as _, appPageTransition as a, appKeepalive as b, createError as c, useRouter as d, entry$1 as default, _export_sfc as e, useHead as f, navigateTo as n, useNuxtApp as u };
