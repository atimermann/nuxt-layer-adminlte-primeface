...
import { ref, mergeProps, useSSRContext, defineComponent, h, Suspense, nextTick, Transition, computed, provide, reactive } from 'vue';
...
const _imports_1 = "" + buildAssetsURL("user8-128x128.2ca5bfaa.jpg");
...
const _imports_4 = "" + buildAssetsURL("user2-160x160.680f6c82.jpg");
const _sfc_main$1 = {
  __name: "SideBarMenu",
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="card-footer"> Footer </div></div></section></div><footer class="main-footer"><div class="float-right d-none d-sm-block"><b>Version</b> 3.2.0 </div><strong>Copyright \xA9 2014-2021 <a href="https://adminlte.io">AdminLTE.io</a>.</strong> All rights reserved. </footer><aside class="control-sidebar control-sidebar-dark"></aside></div>`);
    };
  }
};
...
//# sourceMappingURL=admin-3641a900.mjs.map
